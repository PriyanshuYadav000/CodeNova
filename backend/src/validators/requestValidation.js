...
const validateRegistration = (body) => {
  ...
  const firstName = optionalTrimmedString(
    body,
    "firstName",
    20,
    details,
  ...
  const lastName = optionalTrimmedString(
    body,
    "lastName",
    20,
    details
  ...
  const emailId = optionalTrimmedString(
    body,
    "emailId",
    320,
    details,
  ...
  const password = optionalTrimmedString(
    body,
    "password",
    128,
    details,
...
const validateTestCases = (
  ...
  return testCases.map(
    (testCase, index) => {
      ...
      // Empty string is converted to undefined instead
      // of being treated as a validation error.
      let explanation;
      ...
      if (
        ...
        if (
          typeof testCase.explanation !== "string"
        ) {
          addError(
            details,
            `${path}.explanation`,
          ...
          if (
            trimmedExplanation.length > 10_000
          ) {
            addError(
              details,
              `${path}.explanation`,
          ...
          (tag, index) => {
            if (
              ...
              addError(
                details,
                `tags[${index}]`,
                "must be a non-empty string up to 50 characters"
              );
